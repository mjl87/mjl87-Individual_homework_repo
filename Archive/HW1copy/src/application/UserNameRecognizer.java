	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				//instead of alphanumeric shenanigans, first character of input string
				//is letter instead of number
				
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		// Check for A-Z and a - z
			...
			case 1: 
				...
				// . -> State 2
				//CHANGEEE HERRRREEEEEEEEE
				//added _ and - to be available between alphanumeric inputs
		...
		//MINOR CHANGES HERE
		//made slight changes to print statements to make error messages sync with the errors.
		switch (state) {
		case 0:
